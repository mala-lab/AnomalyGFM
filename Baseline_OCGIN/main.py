...
def main(args):
    ...
    for target_datset in test_datasets:
        ...
        score, y_all = model.predict(dataset=target_dataset, dataloader=target_dataloader, args=args,
                                     return_score=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-model", type=str, default="residual",
                        help="supported model: [Residual, bce, GLocalKD, GLADC, SIGNET, GOOD-D, GraphDE, CVTGAD].")
