...
def load_mat(dataset_train, dataset_test, train_rate=0.3, val_rate=0.1):
    ...
    """Load .mat dataset."""
    # data_train = sio.loadmat("dataset_dimension/{}.mat".format(dataset_train))
    # data_test = sio.loadmat("dataset_dimension/{}.mat".format(dataset_test))
