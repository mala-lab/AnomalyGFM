...
parser.add_argument('--dataset_test', type=str,
                            default='questions_svd')  # YelpChi_rur_svd  yelp  weibo_random reddit_random  tolokers_random tf_finace_random, elliptic_random
...
parser.add_argument('--num_few_train_shot', type=int, default=10)
...
few_shot_train_id = all_idx_test_abnormal[:args.num_few_train_shot]
    ...
    if args.tuning is True:
        for epoch in range(args.num_epoch):
            ...
            if epoch % 2 == 0:
                ...
                # ano_score = ano_score_ab + 0 * ano_score_n
